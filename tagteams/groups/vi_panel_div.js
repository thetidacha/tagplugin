// ._panel_btnshortcut {
    ...
    var vi_list_emailtemplatecontent = {
        ...
        'if_pii_is_visible_available': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <p>Cảm ơn bạn đã lên lịch hẹn với Đội giải pháp kỹ thuật vào lúc <span data-infocase="local_format_meeting_time">01/01/2023</span>. Để chia sẻ màn hình hỗ trợ cho quá trình triển khai, vui lòng nhấp vào đường liên kết sau để tham gia cuộc họp Google Meet: <a href="#" data-infocase_link="customer_gmeet">tại đây</a>
                                                Hoặc qua: <a href="#" data-infocase_link="customer_gmeet" data-infocase="customer_gmeet">LINK</a> . Chúng tôi sẽ liên hệ đến bạn theo số điện thoại được cung cấp: &nbsp;<span data-infocase="customer_contact">0978000000</span>.</p>
                                                <p>&nbsp;</p>
                                                <p>Để buổi cài đặt được triển khai thành công, bạn vui lòng xem qua và <strong>hoàn thành</strong> danh sách sau trước khi cuộc gọi diễn ra:</p>
                                                <ol>
                                                <li>
                                                <p><strong>Chấp thuận “Điều khoản dữ liệu khách hàng"</strong> trong mục Cài đặt Lượt chuyển đổi trước khi cuộc gọi diễn ra. Vui lòng thao tác theo các bước sau: Trên tài khoản Google Ads của bạn, chọn “Đo lường" &gt; chọn “Lượt chuyển đổi" &gt; chọn “Cài đặt" &gt; chấp nhận mục “Điều khoản dữ liệu khách hàng”.</p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo rằng <strong>trang chuyển đổi của bạn có chứa “Thông tin nhận dạng cá nhân của người dùng” </strong>(địa chỉ Email, Số điện thoại).&nbsp;</p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo trang web của bạn được <strong>mã hóa thông qua HTTPS.</strong></p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo rằng người có <strong>quyền quản trị đối với tài khoản Google Ads</strong> (người có thể thực hiện các thay đổi đối với quảng cáo Google Ads)<strong> tham gia vào cuộc gọi.</strong></p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo rằng người có <strong>quyền quản trị đối với mã nguồn trang web của bạn/ hoặc GTM </strong>(ví dụ như quyền truy cập vào bảng điều khiển của Quản trị viên và/ hoặc GTM) <strong>tham gia cuộc gọi</strong> và đảm bảo <strong>tạo bản sao lưu trang web</strong> trước khi triển khai.</p>
                                                </li>
                                                <li>
                                                <p><strong>Kiểm tra lượt chuyển đổi </strong>(Gửi biểu mẫu/ Đặt hàng thành công) là bước quan trọng để xác nhận việc triển khai. Vui lòng đảm bảo người có đủ thẩm quyền để thực hiện các hành động này tham gia vào cuộc gọi.</p>
                                                </li>
                                                </ol>
                                                <p>&nbsp;</p>
                                                <p>Lưu ý : Lượt chuyển đổi nâng cao cho trang web chỉ đủ điều kiện để theo dõi lượt chuyển đổi được thiết lập từ trong tài khoản Google Ads và không được nhập từ các nguồn khác, ví dụ như Google Analytics. Nguồn chuyển đổi phải là Trang web và được cài đặt qua GTM hoặc mã nguồn website thông qua Thẻ toàn trang web. Bạn có thể tham khảo <a href="https://support.google.com/google-ads/answer/9888656?hl=vi">tài liệu này</a> để biết thêm thông tin.</p>
                                                <p><br>Trong trường hợp bạn gặp bất kỳ khó khăn nào với các bước triển khai được liệt kê trên, cuộc gọi sẽ cần phải hẹn lại để hoàn tất cho việc triển khai. <strong>Nếu bạn cần dời lại cuộc hẹn này, vui lòng cho chúng tôi biết bằng cách trả lời email này và chúng tôi sẽ sắp xếp thời gian phù hợp hơn cho bạn.</strong> </p>
        ...
        'automatic_eligible_if_pii_is_not_visible_available': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <ol>
                                                    ...
                                                    <li>
                                                        <p>Đảm bảo trang web của bạn <strong>được mã hóa thông qua HTTPS.</strong></p>
                                                    </li>
                                                    <li>
                                                        <p>Đảm bảo rằng người có<strong> quyền quản trị đối với tài khoản Google Ads </strong>(người có thể thực hiện các thay đổi đối với quảng cáo Google Ads)<strong> tham gia vào cuộc gọi.</strong></p>
                                                    </li>
                                                    <li>
                                                        <p>Đảm bảo rằng người có <strong>quyền quản trị đối với mã nguồn trang web của bạn/ hoặc GTM </strong>(ví dụ như quyền truy cập vào bảng điều khiển của Quản trị viên và/ hoặc GTM) <strong>tham gia cuộc gọi</strong> và <strong>đảm bảo tạo bản sao lưu trang web trước khi triển khai</strong>.</p>
                                                    </li>
                                                    <li>
                                                        <p>Vui lòng liên hệ với Người quản lý tài khoản Google Ads của bạn để đảm bảo bạn có đủ điều kiện tham gia EC Alpha và nó có phù hợp với bạn hay không. Tuy nhiên, nếu bạn vẫn muốn tiếp tục triển khai với phương pháp thủ công, xin hãy liên hệ với Nhà phát triển website của bạn và <strong>đảm bảo rằng trang chuyển đổi của bạn có thông tin Người dùng bắt buộc</strong> (Số điện thoại, địa chỉ email hoặc Tên đầy đủ cùng với Địa chỉ vật lý). Đây là đoạn mẫu của biến lớp dữ liệu <span data-notecontent>{Add data layer code for GTM/Gtag code here}</span>.</p>
                                                    </li>
                                                </ol>
                                                <p>&nbsp;</p>
                                                <p>Lưu ý : Lượt chuyển đổi nâng cao cho trang web chỉ khả dụng cho các lượt chuyển đổi được thiết lập từ trong tài khoản Google Ads và không được nhập từ các nguồn khác, ví dụ như Google Analytics.<strong> Nguồn chuyển đổi phải là Trang web</strong> và được cài đặt qua GTM hoặc mã nguồn website thông qua Thẻ toàn trang web. Bạn có thể tham khảo <a href="https://support.google.com/google-ads/answer/9888656?hl=vi">tài liệu này</a> để biết thêm thông tin.</p>
                                                <p><br>Trong trường hợp bạn gặp bất kỳ khó khăn nào với các bước được liệt kê trước khi triển khai ở trên, cuộc gọi sẽ phải được đặt lại để hoàn tất cho việc triển khai. Nếu bạn cần<strong> dời lại cuộc hẹn này, vui lòng cho chúng tôi biết bằng cách trả lời email này và chúng tôi sẽ sắp xếp thời gian phù hợp hơn cho bạn</strong>. </p>
                                                <p>Trân trọng,</p>
        ...
        'automatic_not_eligible_if_pii_is_not_visible_available': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <p>&nbsp;</p>
                                                <p>Lưu ý : Lượt chuyển đổi nâng cao cho trang web chỉ khả dụng cho lượt chuyển đổi được thiết lập từ trong tài khoản Google Ads và không được nhập từ các nguồn khác, ví dụ như Google Analytics.<strong> Nguồn chuyển đổi phải là Trang web</strong> và được cài đặt qua GTM hoặc mã nguồn website&nbsp; thông qua Thẻ toàn trang web. Bạn có thể tham khảo <a href="https://support.google.com/google-ads/answer/9888656?hl=vi">tài liệu này</a> để biết thêm thông tin.</p>
                                                <p>&nbsp;</p>
                                                <p>Trong trường hợp bạn gặp bất kỳ khó khăn nào với các bước triển khai được liệt kê trên, cuộc gọi sẽ cần phải hẹn lại để hoàn tất cho việc triển khai. Nếu bạn cần<strong> dời lại cuộc hẹn này, vui lòng cho chúng tôi biết bằng cách trả lời email này và chúng tôi sẽ sắp xếp thời gian phù hợp hơn cho bạn</strong>.</p>
                                                <p>&nbsp;</p>
                                                <p>Trân trọng,</p>
        ...
        'ecommerce_website_or_cases_when_you_are_unable_to_check_pii': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                <p>Cảm ơn bạn đã lên lịch hẹn với Đội giải pháp kỹ thuật vào lúc <span data-infocase="local_format_meeting_time">01/01/2023</span>. Để chia sẻ màn hình hỗ trợ cho quá trình triển khai, vui lòng nhấp vào đường liên kết sau để tham gia cuộc họp Google Meet: <a href="#" data-infocase_link="customer_gmeet">tại đây</a>
                                                Hoặc qua: <a href="#" data-infocase_link="customer_gmeet" data-infocase="customer_gmeet">LINK</a> . Chúng tôi sẽ liên hệ đến bạn theo số điện thoại được cung cấp: &nbsp;<span data-infocase="customer_contact">0978000000</span>.</p>
                                                <p>Để buổi cài đặt được triển khai thành công, bạn vui lòng xem qua và hoàn thành danh sách sau trước khi cuộc gọi diễn ra:</p>
                                                <ol>
                                                <li>
                                                <p><strong>Chấp thuận “Điều khoản dữ liệu khách hàng"</strong> trong mục Cài đặt Lượt chuyển đổi trước khi cuộc gọi diễn ra. Vui lòng thao tác theo các bước sau: Trên tài khoản Google Ads của bạn, chọn “Đo lường" &gt; chọn “Lượt chuyển đổi" &gt; chọn “Cài đặt" &gt; chấp nhận mục “Điều khoản dữ liệu khách hàng”.</p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo rằng <strong>trang chuyển đổi của bạn có chứa “Thông tin nhận dạng cá nhân của người dùng” </strong>(địa chỉ Email, Số điện thoại). Bạn có thể tìm hiểu thêm từ <a href="https://support.google.com/google-ads/answer/10172785?hl=vi#zippy=%2Cidentify-and-define-your-enhanced-conversions-variables">bài viết này</a> để kiểm tra sự hiện diện của các trường thông tin cần thiết trên trang website.</p>
                                                </li>
                                                <li>
                                                <p>Nếu không, bạn cần kiểm tra tài khoản Google Ads có đang ghi nhận hơn 5 lượt chuyển đổi mỗi ngày, lượt chuyển đổi có thể đến từ bất kỳ hành động nào với Nguồn chuyển đổi là “Trang web”. Nếu không, bạn sẽ cần liên hệ đến nhà phát triển website để đảm bảo <strong>trang chuyển đổi của bạn có chứa “Thông tin nhận dạng cá nhân của người dùng”</strong> (địa chỉ Email, Số điện thoại) hoặc nhà phát triển website có thể đẩy biến lớp dữ liệu vào trang chuyển đổi của bạn hay không?</p>
                                                </li>
                                                <li>
                                                <p>Đảm bảo trang web của bạn được <strong>mã hóa thông qua HTTPS.</strong></p>
                                                </li>
        ...
        'if_an_advertiser_is_eligible_for_the_automatic_option_based_on_pre_call_checks_keep_either_gtm_or_gtag_one_of_the_two_options_below_option_based_on_advertisers_conversion_set_up': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                            ...
                            <td align="center" style="padding: 0px 40px 30px 30px;" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                <p>Cảm ơn bạn đã quan tâm về việc triển khai Chuyển đổi Nâng cao. Chúng tôi nhận thấy bạn đã đủ điều kiện để thiết lập theo dõi Chuyển đổi Nâng cao tự động. Vui lòng thao tác theo các bước sau để hoàn tất thiết lập.</p>
                                                <h3>Hướng dẫn</h3>
                                                <ol>
                                                    <li>
                                                        <p>Đăng nhập vào <a href="https://ads.google.com/intl/vi_vn/home/">tài khoản Google Ads</a> của bạn.</p>
                                                    </li>
                                                    <li>
                                                        <p>Ở góc trên bên phải của tài khoản, hãy nhấp vào biểu tượng công cụ và bên dưới mục "<strong>Đo lường</strong>", hãy nhấp vào <strong>Lượt</strong> <strong>chuyển đổi</strong>.</p>
                                                    </li>
                                                    <li>
                                                        <p>Mở hành động chuyển đổi mà bạn muốn sử dụng tính năng lượt chuyển đổi nâng cao.</p>
                                                    </li>
                                                    <li>
                                                        <p>Trong phần "Lượt chuyển đổi nâng cao" ở dưới cùng, hãy nhấp vào Bật tính năng lượt chuyển đổi nâng cao.</p>
                                                    </li>
                                                    <li>
                                                        <p>Nhấp vào Đồng ý với tuyên bố tuân thủ điều khoản điều kiện. Bằng cách bật tính năng lượt chuyển đổi nâng cao, bạn xác nhận rằng mình tuân thủ các <a href="https://support.google.com/adspolicy/answer/7475709?hl=vi">chính sách của chúng tôi</a>. <a href="https://business.safety.google/adsprocessorterms/">Điều khoản xử lý dữ liệu của Google Ads</a> (chỉ có bản Tiếng Anh) áp dụng cho việc bạn sử dụng tính năng lượt chuyển đổi nâng cao.</p>
                                                    </li>
                                                    <li>
                                                        <p>Kiểm tra trang web của bạn để tìm thẻ Google bằng cách nhập URL trang đích của bạn và nhấp vào Kiểm tra URL.</p>
                                                    </li>
                                                    <li>
                                                        <p>Trong “Loại thẻ”, bạn sẽ thấy tính năng cài đặt mặc định là Trình quản lý thẻ của Google hoặc thẻ Google của bạn. Bất kỳ phương pháp nào bạn đã sử dụng để thiết lập thẻ trang web cũng sẽ được sử dụng để thiết lập lượt chuyển đổi nâng cao.</p>
                                                    </li>
                                                    <li>
                                                        <p>Nếu bạn đang sử dụng thẻ Google, bạn sẽ được mặc định sử dụng “Thiết lập tự động” nếu khả dụng và có thể hoàn tất thiết lập của mình từ màn hình này. Nếu đang sử dụng Trình quản lý thẻ của Google, bạn có thể nhấp vào Lưu và mở tài khoản Trình quản lý thẻ của Google để hoàn tất <a href="https://support.google.com/google-ads/answer/10763826?hl=vi&amp;ref_topic=11337914#Complete_GTM&amp;zippy=%2Ccompleting-automatic-setup-in-google-tag-manager%2Cho%C3%A0n-t%E1%BA%A5t-quy-tr%C3%ACnh-thi%E1%BA%BFt-l%E1%BA%ADp-t%E1%BB%B1-%C4%91%E1%BB%99ng-trong-tr%C3%ACnh-qu%E1%BA%A3n-l%C3%BD-th%E1%BA%BB-c%E1%BB%A7a-google">phần còn lại của quá trình thiết lập</a>.</p>
                                                    </li>
                                                    <li>
                                                        <p>Tiếp theo, bạn sẽ chọn những phần thông tin khách hàng mà bạn muốn sử dụng cho lượt chuyển đổi nâng cao. Tại thời điểm này, <strong>chỉ có Email khả dụng</strong> nhưng trong tương lai có thể có các tùy chọn khác như Địa chỉ và Số điện thoại.</p>
                                                    </li>
                                                    <li>
                                                        <p>Nhấp vào Lưu. Bạn sẽ thấy thông báo rằng Google cần một chút thời gian để đánh giá xem chuyển đổi của bạn có hoạt động bình thường với “Thiết lập tự động” hay không. Bạn có thể kiểm tra lại sau khoảng 1 tuần để xem xét trạng thái của hành động chuyển đổi của mình và xem liệu có cần thực hiện bất kỳ hành động bổ sung nào.<br><br></p>
                                                    </li>
                                                </ol>
                                                <p>Tới đây bạn đã triển khai thành công lượt chuyển đổi nâng cao cho hành động chuyển đổi này. Lặp lại các bước này cho từng hành động chuyển đổi mà bạn muốn triển khai tính năng lượt chuyển đổi nâng cao.</p>
                                                <p>&nbsp;</p>
                                                <p>Vui lòng lưu ý rằng bạn sẽ thấy thông báo rằng <strong>“Google cần một chút thời gian để đánh giá xem chuyển đổi của bạn có hoạt động bình thường với “Thiết lập tự động”</strong> hay không. B<strong>ạn có thể kiểm tra lại sau 1 tuần để xem lại trạng thái của hành động chuyển đổi</strong> và liên hệ với Đội ngũ Kỹ thuật đại diện Google nếu cần thực hiện bất kỳ hành động khắc phục hay bổ sung, và chúng tôi sẵn lòng hỗ trợ bạn.</p>
                                                <br>


                                                <div data-notetitle="[KHÔNG BAO GỒM sau phần này nếu đó là thiết lập gTag] Hoàn tất Thiết lập tự động trong Trình quản lý thẻ của Google)">
                                                    <p>Trước tiên, hãy đảm bảo rằng bạn đã đợi 5 ngày sau khi ký Điều khoản dịch vụ trong tài khoản Google Ads của mình. Sau khoảng thời gian này, bạn có thể kiểm tra các thẻ theo dõi chuyển đổi của mình trong Trình quản lý thẻ của Google để xem các thẻ đó có được bật cho chuyển đổi nâng cao hay không và tiếp tục triển khai thiết lập.<br><br></p>
                                                    <ol>
                                                        <li>
                                                            <p>Đăng nhập vào tài khoản <a href="https://tagmanager.google.com/#/home">Trình quản lý thẻ của Google</a>.</p>
                                                        </li>
                                                        <li>
                                                            <p>Nhấp vào Không gian làm việc, sau đó nhấp vào <a href="https://support.google.com/tagmanager/answer/3281060">Thẻ</a> từ menu điều hướng.</p>
                                                        </li>
                                                        <li>
        ...
        'if_advertiser_imports_google_analytics_conversions_for_tracking_and_wants_to_implement_ec': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                            ...
                            <td align="center" style="padding: 0px 40px 30px 30px;" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                <p>Cảm ơn bạn đã quan tâm đến việc triển khai Lượt chuyển đổi nâng cao. Chúng tôi nhận thấy rằng bạn đang nhập chuyển đổi Google Analytics (GA) vào Google Ads. Nếu bạn đang tìm cách triển khai Lượt chuyển đổi nâng cao cho các lượt chuyển đổi đã nhập từ GA, thì lưu ý rằng &nbsp;<strong>Lượt chuyển đổi nâng cao hiện tại chỉ khả dụng cho những lượt chuyển đổi sử dụng nguồn từ Website / sử dụng tính năng theo dõi lượt chuyển đổi gTag</strong>. Chúng tôi xin lỗi vì bất kỳ sự bất tiện nào mà điều này có thể đã gây ra.</p>
                                                <br>
                                                <p>Trân trọng,</p>
        ...
        'if_advertiser_cms_is_not_supported_for_ec_implementation_send_this_email': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao</td>
                            ...
                            <td align="center" style="padding: 0px 40px 30px 30px;" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                <p>Cảm ơn bạn đã quan tâm đến việc triển khai Lượt chuyển đổi nâng cao. Chúng tôi nhận thấy rằng bạn đang sử dụng Hệ thống quản lý nội dung (CMS) của {Insert CMS Name} và hiện tại chúng tôi không thể hỗ trợ triển khai cho CMS này. Vui lòng liên hệ với Đội ngũ hỗ trợ nền tảng CMS tương ứng của bạn để được hướng dẫn. Chúng tôi xin lỗi vì bất kỳ sự bất tiện nào mà điều này có thể đã gây ra.</p>
                                                <br>
                                                <p>Trân trọng,</p>
                        ...
                        <div class="btn--group _panel__topsticky_toolbar">
                            <div class="_panel__topsticky_toolbar-gr">
                                ...
                                <!-- <span class="_panel_btn _panel_btn--small _panel_btn--iconimg" data-btnaction="load_casecurrent" title="Load Current">
                                    <img src="https://www.svgrepo.com/show/311132/reading-list.svg">
                                </span> -->
                ...
                <div data-panel="email-template">
                    ...
                    <div class=" _panel__inner">
                        ...
                        <div class="_emailtemp">
                            ...
                            <div class="_emailtemp-item" data-type="[EC] If PII is Visible / Available ">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                ...
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.if_pii_is_visible_available}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] (Automatic eligible) If PII is not Visible / Available">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật -  Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.automatic_eligible_if_pii_is_not_visible_available}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] (Automatic - Not eligible) If PII is not Visible / Available">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật - Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.automatic_not_eligible_if_pii_is_not_visible_available}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] Ecommerce website Or Cases when you are unable to check PII">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật -  Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.ecommerce_website_or_cases_when_you_are_unable_to_check_pii}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] If an advertiser is Eligible for the  Automatic Option (based on Pre-Call Checks) - Keep either GTM or gTag (one of the two options below) option based on Advertiser’s conversion set up">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật -  Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.if_an_advertiser_is_eligible_for_the_automatic_option_based_on_pre_call_checks_keep_either_gtm_or_gtag_one_of_the_two_options_below_option_based_on_advertisers_conversion_set_up}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] If Advertiser imports Google Analytics conversions for tracking and wants to implement EC">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật -  Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.if_advertiser_imports_google_analytics_conversions_for_tracking_and_wants_to_implement_ec}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="_emailtemp-item" data-type="[EC] If advertiser CMS is not supported for EC Implementation, send this email">
                                <span class="_panel_btn _panel_btn--small _panel_btn--addtemplate">Insert</span>
                                <div class="_emailtemp-item__title">Đội giải pháp kỹ thuật -  Những điều kiện cần thiết cho Cuộc hẹn triển khai Chuyển đổi nâng cao [<span data-infocase="case_id">5-0000000000000</span>]</div>
                                <div class="_emailtemp-item__content">
                                    <div id="email-body-content-top" style="width:100%">
                                        <div id="email-body-content-top-content">
                                            ${vi_list_emailtemplatecontent.if_advertiser_cms_is_not_supported_for_ec_implementation_send_this_email}
                                        </div>
                                    </div>
                                </div>
                            </div>
