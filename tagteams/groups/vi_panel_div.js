            ...
            <div data-panel="script-reading">
                ...
                <div class=" _panel__inner">
                    ...
                    <div class="_panel__script"> <br>
                        <div class="_panel__script--elm" data-title="1. Chào hỏi xác nhận thông Adv"> <br>Dạ em chào <span data-infocase="customer_gender">C2</span>, em là <span data-infosetting="your-shortname">Đông</span> đến từ đội giải pháp kỹ thuật đại diện Google
                            <br>có phải em <span data-infosetting="your-shortname">Đông</span> đang nghe máy với <span data-infocase="customer_gender">C2</span> <span data-infocase="customer_name">B2</span> đó không?
                            <br>// KH: đúng rồi em!
                            <br> <br>
                        ...
                        <div class="_panel__script--elm" data-title="2. Thủ tục"> <br>Trước khi bắt đầu cài đặt <span data-infocase="customer_gender">C2</span> lưu ý giúp em cuộc gọi này sẽ được ghi âm nhằm nâng cao chất lượng dịch vụ [cho] khách hàng , <span data-infocase="customer_gender">C2</span> nha!
                            ...
                            <br>em <span data-infosetting="your-shortname">Đông</span> có gởi cho <span data-infocase="customer_gender">C2</span> một email có link google meet [á] để chia sẽ màn hình với em, <span data-infocase="customer_gender">C2</span> truy cập vào giúp em nha
                            <br>// KH: OK em
                    ...
                    <div class="_emailtemp">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%" dir="auto">
                                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                                        <p dir="auto">Xin chào <span data-infocase="customer_gender">anh</span> <span data-infocase="customer_name"><span data-infosetting="your-shortname">Đông</span> đẹp trai</span><br></p>
                        ...
                        <div class="_emailtemp-item" data-type="SO - Verified">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font-style: normal; font-variant: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block;" dir="auto">
                                        <p dir="auto" style="font-weight: normal;"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name"><span data-infosetting="your-shortname">Đông</span> đẹp trai</span>&nbsp;thân mến!</p>
