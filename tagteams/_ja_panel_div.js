var ja_panel_div = `
<div id="_panel_div" class="_panel active hide_main hide_toolbar hide_opentiptutorial hide_opensetting hide_emailtemplate">
    <style>
        @import url("https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@400;700&display=swap"); ._panel { --scrollbar-track-bg: #f0f0f0; --scrollbar-thumb-bg: #ccc; font-family: Roboto, Arial; position: fixed; width: 80%; max-width: 1024px; height: 0; background-color: #fff; top: 45px; left: auto; right: 0; opacity: 0; transform: translateX(100%); transition: opacity 0.3s ease; z-index: 9999; color: #000; } ._panel form { margin: 0; } ._panel *:after, ._panel *:before, ._panel * { box-sizing: border-box; } ._panel.minisize { width: 100%; max-width: 500px; } ._panel ._panel_group { position: relative; z-index: 9; transition: opacity 0.3s ease-in-out, transform 0.3s ease-in-out; opacity: 1; transform: scale(1); transform-origin: left top; } ._panel.hide_main ._panel_group[data-group=main] { opacity: 0; transform: scale(0); } ._panel.hide_main [data-btnaction=openmain] { background-size: 60%; } ._panel_darkmode { filter: invert(1); } ._panel_darkmode [data-blogs_image], ._panel_darkmode img[src*="Google_2015_logo.svg"] { filter: invert(1); } ._panel.hide_toolbar ._panel_group[data-group=toolbar] { opacity: 0; transform: scale(0); } ._panel.hide_toolbar [data-btnaction=opentoolbar] { background-size: 60%; } ._panel.hide_emailtemplate ._panel_group[data-group=emailtemplate] { opacity: 0; transform: scale(0); } ._panel.hide_emailtemplate [data-btnaction=openemailtemplate] { background-size: 60%; } ._panel.hide_opentiptutorial ._panel_group[data-group=opentiptutorial] { opacity: 0; transform: scale(0); } ._panel.hide_opentiptutorial [data-btnaction=opentiptutorial] { background-size: 60%; } ._panel.hide_opensetting ._panel_group[data-group=opensetting] { opacity: 0; transform: scale(0); } ._panel.hide_opensetting [data-btnaction=opensetting] { background-size: 60%; } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar { width: 12px; height: 12px; } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar:horizontal { width: 9px; height: 9px; } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar-track { background-color: var(--scrollbar-track-bg); } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar-track:horizontal { border-radius: 8px; } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar-thumb { border-radius: 8px; border: 3px solid var(--scrollbar-track-bg); background-color: var(--scrollbar-thumb-bg); } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar-thumb:horizontal { border: 0; } ._panel :not(.no-custom-scrollbar)::-webkit-scrollbar-corner { border-radius: 8px; background-color: var(--scrollbar-track-bg); } ._panel a { text-decoration: none; color: #009688; } ._panel a:hover { color: red; } ._panel ul { list-style: none; margin: 0; padding: 0; } ._panel textarea, ._panel input { border: 1px solid #eee; border-radius: 0; line-height: 1.5; margin: 4px 0; font-family: Roboto, Arial; font-size: 100%; } ._panel textarea[type=text], ._panel input[type=text] { padding: 3px; } ._panel textarea[type=date], ._panel input[type=date] { padding: 3px; } ._panel textarea[type=checkbox], ._panel input[type=checkbox] { margin: 0 5px; } ._panel textarea:focus, ._panel textarea:focus-visible, ._panel input:focus, ._panel input:focus-visible { outline: 0; } ._panel textarea { padding: 3px; font-family: Roboto, Arial; } ._panel select { font-size: 100%; width: 100%; border: 1px solid #eee; padding: 5px; border-radius: 0; cursor: pointer; } ._panel select#qlus_status { font-weight: bold; border: 0; background: transparent; outline: 0; display: inline; width: 154px; padding-left: 0; font-size: 87%; } ._panel select.select_inline { display: inline; width: auto; border: 0; background: transparent; padding: 0; } ._panel textarea, ._panel input[type=text] { width: 100%; } @keyframes progressLinearMovement { 0% { left: -100%; } 50% { left: 100%; } 100% { left: 100%; } } ._panel__linear-progress { background: #bbdefb; height: 10px; position: relative; width: 100%; margin: 0 auto; overflow: hidden; animation: start 0.3s ease-in; } ._panel__linear-progress.small { width: 100%; height: 2px; } ._panel__linear-progress .bar { position: absolute; background: #1565c0; transition: transform 0.2s linear; left: 0; top: 0; bottom: 0; width: 100%; } ._panel__linear-progress .bar1 { animation: progressLinearMovement 2.5s infinite; -webkit-animation-delay: 0; animation-delay: 0; } ._panel__linear-progress .bar2 { left: -100%; animation: progressLinearMovement 2.5s infinite; animation-delay: 0.7s; } ._panel__notification_proccess, ._panel__notification_alert { border-radius: 3px; background-color: #ff5722; padding: 2px 10px; font-size: 80%; color: #fff; margin-top: 0; } ._panel__notification_proccess:not(:last-child), ._panel__notification_alert:not(:last-child) { margin-bottom: 10px; } ._panel__notification_proccess { background-color: #ffc107; } ._panel__topsticky_toolbar { position: sticky; top: 45px; left: 0; background: #fff; padding: 5px; z-index: 999; display: flex; flex-wrap: nowrap; justify-content: space-between; align-items: flex-start; } ._panel__topsticky_toolbar ._panel_btn { margin-right: 6px; margin-bottom: 6px; } ._panel__topsticky_toolbar-gr { display: flex; flex-wrap: wrap; align-items: center; } ._panel_toastify { padding: 6px 18px; color: #ffffff; display: inline-block; box-shadow: 0 0 34px #d4d4d4; background: #00bcd4; position: fixed; top: -150px; right: 15px; opacity: 0; transition: all 0.4s cubic-bezier(0.215, 0.61, 0.355, 1); border-radius: 2px; cursor: pointer; z-index: 99999; font-family: Roboto, Arial; font-size: 12px; } ._panel_toastify.warning { background: #ff5722; } ._panel_toastify.success { background: #4caf50; } ._panel_toastify.on { opacity: 1; } ._panel__form { font-size: 90%; display: flex; justify-content: space-between; } ._panel__form label { display: flex; flex-direction: row; align-content: center; justify-content: flex-start; flex-wrap: wrap; -webkit-user-select: none; user-select: none; align-items: center; } ._panel__form label:not(:last-child) { margin-bottom: 10px; } ._panel__form--label_inputcenter { align-items: center; } ._panel__form ._gr50 { flex: calc(50% - 10px); } ._panel__form ._gr50:not(:last-child) { margin-right: 10px; } ._panel__form--panel { border: 1px solid #eee; padding: 10px; margin-bottom: 10px; } ._panel__form--column { flex-basis: 0; flex-grow: 1; max-width: 100%; } ._panel__form--column:not(:last-child) { margin-right: 10px; } ._panel.active { opacity: 0.9; transform: translateX(0%); } ._panel__heading { height: 45px; border-bottom: 1px solid #ccc; display: flex; justify-content: space-between; align-items: center; padding: 0 16px; position: sticky; top: 0; background: #fff; -webkit-user-select: none; user-select: none; z-index: 2; } ._panel__heading img { max-height: 24px; } ._panel__heading--group { height: 45px; display: flex; align-items: center; } ._panel__heading--title { margin-left: 8px; font-size: 10px; } ._panel__heading--close { cursor: pointer; margin-right: 12px; } ._panel_btn { font-size: 90%; font-weight: bold; padding: 6px 10px; background-color: #fff; border-radius: 4px; display: inline-flex; color: #333; cursor: pointer; user-select: none; border: 1px solid #c8c8c8; line-height: 1; font-weight: normal; white-space: nowrap; align-items: center; } ._panel_btn--small { font-size: 10px; } ._panel_btn--group { margin-bottom: 6px; } ._panel_btn--fullwidth { width: 100%; } ._panel_btn--mb6px { margin-bottom: 6px; } ._panel_btn:not(:last-child) { margin-right: 6px; } ._panel_btn:hover { background-color: rgba(0, 150, 135, 0.5725490196); } ._panel_btn--success { background-color: #4caf50; color: #fff; } ._panel_btn--svg { padding: 2px 10px; } ._panel_btn svg { height: 16px; width: 16px; } ._panel_btn._panel_btn--icon { margin-right: 10px; } ._panel_btn._panel_btn--icon svg { margin-right: 10px; } ._panel_btn._panel_btn--icon img { width: auto; height: 10px; transform: scale(1.6); margin-right: 7px; } ._panel_btn > * { pointer-events: none; } ._panel_btn._notchange { opacity: 0.5; background-color: #ccc; pointer-events: none; } ._panel__tabs-header { display: flex; flex-wrap: nowrap; align-items: center; justify-content: flex-start; flex-direction: row; border-bottom: 2px solid #eee; } ._panel__tabs-header [data-tabs] { padding: 8px 16px; font-weight: bold; border-bottom: 2px solid transparent; cursor: pointer; margin-bottom: -2px; margin-right: 10px; } ._panel__tabs-header [data-tabs]:hover, ._panel__tabs-header [data-tabs].active { border-bottom-color: rgb(87, 56, 56); } ._panel__tabs-content [data-tabs] { padding: 16px; overflow: auto; max-height: calc(100vh - 90px); } ._panel__tabs-content [data-tabs]:not(.active) { display: none; } ._panel__tabs--area { border: 1px solid #eee; padding: 10px; } ._panel__tabs--allcolumn { display: flex; flex-wrap: wrap; flex-direction: row; align-items: flex-start; } ._panel__tabs--allcolumn_detail, ._panel__tabs--allcolumn_list { flex: 50%; } ._panel__tabs--allcolumn_list { padding: 16px; } ._panel__script p { margin-top: 0; margin-bottom: 0; } ._panel__script--header { position: sticky; top: 45px; color: red; padding: 10px; z-index: 999; background: #fff; } ._panel__script--elm { background-color: rgba(76, 175, 80, 0.2); padding: 10px; line-height: 1.3; position: relative; padding-top: 30px; font-size: 14px; } ._panel__script--elm:before { content: attr(data-title); font-size: 10px; background-color: #ccc; width: 100%; position: absolute; top: 0; left: 0; padding: 6px; cursor: pointer; } ._panel__script--elm:not(:last-child) { margin-bottom: 10px; } ._panel__script--elm [data-infocase] { font-weight: bold; user-select: all; } ._panel__script--elm.hide { height: 45px; overflow: hidden; } ._panel__caseview { font-size: 100%; line-height: 1.8; } ._panel__caseview [data-infocase_link=case_id] svg, ._panel__caseview [data-infocase_link=customer_gmeet] svg, ._panel__caseview [data-infocase_link=customer_ocid] svg { width: 18px; height: 18px; } ._panel__caseview [data-infocase=qlus_status], ._panel__caseview [data-infocase=case_id] { font-weight: bold; } ._panel__caseview [data-infocase=case_id] { color: #673ab7; } ._panel__caseview [data-infocase=customer_contact] { font-size: 120%; } ._panel__caseview [data-infocase=am_email], ._panel__caseview [data-infocase=customer_email], ._panel__caseview [data-infocase=customer_adsid_format], ._panel__caseview [data-infocase=case_id], ._panel__caseview [data-infocase=qlus_status], ._panel__caseview [data-infocase=customer_contact] { user-select: all; } ._panel__caseview [name=note], ._panel__caseview [name=request], ._panel__caseview [data-infocase=note], ._panel__caseview [data-infocase=request] { display: block; border: 1px dashed; padding: 6px; font-style: italic; font-size: 90%; overflow: hidden; resize: none; } ._panel__caseview [data-infocase_link=customer_gmeet][href*="meet.google.com/"]:before { content: "Link Google Meet"; } ._panel__caselist li { cursor: pointer; font-size: 100%; position: relative; padding: 6px; } ._panel__caselist li:not(:hover) [data-action=remove_case] { opacity: 0; pointer-events: none; } ._panel__caselist li:not(:last-child) { margin-bottom: 12px; } ._panel__caselist li.active { box-shadow: 0 0 29px inset rgba(233, 30, 99, 0.5); background-color: #fff; } ._panel__caselist li:hover { background-color: #eee; } ._panel__caselist li._has_qlus_status { padding-bottom: 14px; } ._panel__caselist li._has_qlus_status ._bottom { top: calc(100% - 14px); } ._panel__caselist li ._bottom { position: absolute; top: calc(100% - 10px); left: 6px; } ._panel__caselist li ._bottom small { font-size: 60%; background: #9e9e9e; color: #fff; border-radius: 3px; padding: 2px 6px; } ._panel__caselist li ._right { position: absolute; right: 10px; top: 50%; transform: translateY(-50%); } ._panel__caselist li ._meeting_time[data-status=Today] { background-color: #673ab7; } ._panel__caselist li ._qlus_status[data-status="SO - Verification Not Needed"], ._panel__caselist li ._qlus_status[data-status="SO - Verified"] { background-color: #8ad68d; } ._panel__caselist li ._qlus_status[data-status="AS - Reschedule 1"] { background-color: #2196f3; } ._panel__caselist li ._qlus_status[data-status="NI - Awaiting Validation"], ._panel__caselist li ._qlus_status[data-status="NI - Attempted Contact"] { background-color: #00bcd4; } ._panel__caselist li ._qlus_status[data-status="AS - Work in Progress"] { background-color: #2196f3; } ._panel__caselist li[data-titletoday] { background: #FF9800; padding: 1px; position: relative; pointer-events: none; } ._panel__caselist li[data-titletoday]:before { content: attr(data-titletoday); position: absolute; border-radius: 5px; font-size: 70%; right: 0; top: 50%; transform: translateY(-50%); background: #fff; padding: 2px 10px; border: 1px solid #ccc; } ._panel [data-panel] { position: fixed; width: 100%; max-height: 100vh; height: 600px; overflow: auto; background: #fff; right: 0; transition: 0.3s ease-in-out; transform: translateX(0); box-shadow: 0 0 50px #ccc; } ._panel [data-panel]:not(:first-child) { width: 95%; z-index: 2; background: #fff; } ._panel [data-panel]:not(.active) { transform: translateX(100%); box-shadow: 0 0 0 #ccc; opacity: 0; pointer-events: none; } ._panel [data-panel][data-panel=form-case] { width: 70%; } ._panel [data-panel][data-panel=list-case] { width: 50%; } ._panel [data-panel][data-panel=toolbar] { bottom: 0; left: 45px; height: auto; width: fit-content; } ._panel [data-panel][data-panel=opentiptutorial] { top: 45px; left: 135px; } ._panel [data-panel][data-panel=opensetting] { top: 45px; left: 180px; height: auto; } ._panel.list-case__active:not(.minisize) [data-panel=main] { padding-right: 48%; } ._panel.list-case__active:not(.minisize) [data-panel=list-case] { width: 50%; } ._panel [data-panel=script-reading]:not([data-isgcc="1"]) [data-am_donvi=GCC] { display: none; } ._panel [data-panel=script-reading][data-isgcc="1"] [data-am_donvi]:not([data-am_donvi=GCC]) { display: none; } ._panel [data-qlus_status="AS - Work in Progress"] ._emailtemp-item[data-type="AS - Work in Progress"], ._panel [data-qlus_status="SO - Verified"] ._emailtemp-item[data-type="SO - Verified"], ._panel [data-qlus_status="SO - Verification Not Needed"] ._emailtemp-item[data-type="SO - Verification Not Needed"], ._panel [data-qlus_status="AS - Reschedule 1"] ._emailtemp-item[data-type="AS - Reschedule 1"], ._panel [data-qlus_status="NI - Attempted Contact"] ._emailtemp-item[data-type="NI - Attempted Contact"], ._panel [data-qlus_status="IN - Not Reachable"] ._emailtemp-item[data-type="IN - Not Reachable"], ._panel [data-qlus_status="NI - Awaiting Validation"] ._emailtemp-item[data-type="NI - Awaiting Validation"] { order: 0; border: 1px dashed green; } ._panel__inner { padding: 16px; z-index: 1; position: relative; } ._panel_btntinhnang { display: inline-block; position: absolute; right: 100%; background-color: #fff; border: 1px solid #ccc; width: 45px; height: 45px; padding: 6px; z-index: 999999; } ._panel_btntinhnang svg { width: 100%; height: 100%; } ._panel_btntinhnang * { pointer-events: none; } ._panel_btntinhnang[data-btnaction] { background-size: 100%; } ._panel_btntinhnang[data-btnaction=move] { cursor: move; } ._panel_btntinhnang[data-btnaction=move] svg path { fill: #777; } ._panel_btntinhnang[data-btnaction=openmain], ._panel_btntinhnang[data-btnaction=opentoolbar], ._panel_btntinhnang[data-btnaction=openemailtemplate], ._panel_btntinhnang[data-btnaction=opentiptutorial], ._panel_btntinhnang[data-btnaction=opensetting] { left: 0; z-index: 2; background-repeat: no-repeat; background-position: center; cursor: pointer; border-left: 0; transition: background-size 0.3s ease; } ._panel_btntinhnang[data-btnaction=openmain] img, ._panel_btntinhnang[data-btnaction=opentoolbar] img, ._panel_btntinhnang[data-btnaction=openemailtemplate] img, ._panel_btntinhnang[data-btnaction=opentiptutorial] img, ._panel_btntinhnang[data-btnaction=opensetting] img { max-width: 100%; max-height: 100%; } ._panel_btntinhnang[data-btnaction=opentoolbar] { left: 45px; } ._panel_btntinhnang[data-btnaction=openemailtemplate] { left: 90px; } ._panel_btntinhnang[data-btnaction=opentiptutorial] { left: 135px; } ._panel_btntinhnang[data-btnaction=opensetting] { left: 180px; } ._panel ul.list_keystorage { padding: 10px; border: 1px solid #ccc; margin-top: 10px; max-height: 200px; overflow: auto; font-size: 90%; } ._panel ul.list_keystorage li { margin-bottom: 6px; position: relative; display: flex; justify-content: space-between; align-items: center; } ._panel ul.list_keystorage li:nth-child(odd) { background-color: #ebebeb; } ._panel ul.list_keystorage [data-btnremovekeystorage] { cursor: pointer; font-size: 80%; } ._panel__blogs { display: flex; flex-direction: row; flex-wrap: wrap; justify-content: space-between; } ._panel__blogs [data-blogs] { max-width: calc(50% - 5px); flex: calc(50% - 5px); border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; font-size: 80%; } ._panel__blogs [data-blogs]:not(.full) [data-blogs_content] { display: none; } ._panel__blogs [data-blogs].full [data-blogs_content_expect] { display: none; } ._panel__blogs [data-blogs]:not(.full) { cursor: pointer; } ._panel__blogs [data-blogs].full { max-width: 100%; flex: 100%; border-color: red; } ._panel__blogs [data-blogs_image] { height: 110px; margin-bottom: 10px; background-size: cover; background-position: center; } ._panel__blogs [data-blogs_title] { font-weight: bold; margin-bottom: 10px; } ._panel__blogs [data-blogs_expand] { display: inline-block; margin-top: 10px; border: 1px solid #ccc; padding: 3px 8px; border-radius: 3px; font-size: 78%; cursor: pointer; user-select: none; } ._panel__ghost [ng-value="$ctrl.JustificationType.SALES_REASON"] { text-decoration: line-through; } ._emailtemp { display: flex; flex-wrap: wrap; } ._emailtemp-item { flex: 0 0 calc(33.33% - 10px); max-height: 300px; overflow: hidden; text-overflow: ellipsis; border: 1px solid #eee; padding: 10px; order: 2; margin-right: 10px; margin-bottom: 10px; } ._emailtemp-item::before { content: attr(data-type); display: block; background: #2a2a2a; margin-bottom: 10px; padding: 5px; color: #fff; border-radius: 4px; font-size: 11px; } .minisize ._emailtemp-item { flex: 0 0 100%; } ._emailtemp-item__title { margin-top: 10px; }
    </style>
    <span class="_panel_btntinhnang" data-btnaction="move">
            ...
            <div data-panel="script-reading">
                ...
                <div class=" _panel__inner">
                    ...
                    <div class="_panel__script"> <br>
                        <div class="_panel__script--elm" data-title="1. Chào hỏi xác nhận thông Adv"> <br>Dạ em chào <span data-infocase="customer_gender">C2</span>, em là Đông đến từ đội giải pháp kỹ thuật đại diện Google
                            <br>có phải em Đông đang nghe máy với <span data-infocase="customer_gender">C2</span> <span data-infocase="customer_name">B2</span> đó không?
                            <br>// KH: đúng rồi em!
                            <br> <br>
                        ...
                        <div class="_panel__script--elm" data-title="2. Thủ tục"> <br>Trước khi bắt đầu cài đặt <span data-infocase="customer_gender">C2</span> lưu ý giúp em cuộc gọi này sẽ được ghi âm nhằm nâng cao chất lượng dịch vụ [cho] khách hàng , <span data-infocase="customer_gender">C2</span> nha!
                            ...
                            <br>em Đông có gởi cho <span data-infocase="customer_gender">C2</span> một email có link google meet [á] để chia sẽ màn hình với em, <span data-infocase="customer_gender">C2</span> truy cập vào giúp em nha
                            <br>// KH: OK em
                    ...
                    <div class="_emailtemp">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%" dir="auto">
                                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                                        <p dir="auto">Xin chào <span data-infocase="customer_gender">anh</span> <span data-infocase="customer_name">Đông đẹp trai</span><br></p>
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width: 100%;">
                                    <div id="email-body-content-top-content" style=" font-style: normal; font-variant: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block; " dir="auto">
                                        <p dir="auto"> <span style="font-weight: normal;"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Liêm</span></span> thân mến!<br /> <br /> Chúng tôi đã nhận được yêu cầu của anh về việc dời lịch cho cuộc gọi hỗ trợ triển khai <b><span data-infocase="request">ZZZ</span> </b> cho <span><b><span data-infocase="customer_website">nhuahuongchi.com</span></b></span>. </p>
                        ...
                        <div class="_emailtemp-item" data-type="SO - Verified">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font-style: normal; font-variant: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block;" dir="auto">
                                        <p dir="auto" style="font-weight: normal;"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Đông đẹp trai</span>&nbsp;thân mến!</p>
                        ...
                        <div class="_emailtemp-item" data-type="NI - Attempted Contact">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font-style: normal; font-variant: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block;" dir="auto">
                                        <p dir="auto"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Liêm</span>
                                            thân mến!<br>
                                            <br>
                        ...
                        <div class="_emailtemp-item" data-type="IN - Not Reachable">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                                        <p><strong> </strong><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Liêm</span> thân mến!</p>
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block;" dir="auto">
                                        <p style="font-style: normal;"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Liêm</span>&nbsp;
                                            thân mến!
                                        </p>
                        ...
                        <div class="_emailtemp-item" data-type="NI - Awaiting Validation">
                            ...
                            <div class="_emailtemp-item__content">
                                <div id="email-body-content-top" style="width:100%">
                                    <div id="email-body-content-top-content" style="font-style: normal; font-variant: normal; font-stretch: normal; font-size: 13px; line-height: 17px; font-family: Roboto, sans-serif; display: block;" dir="auto">
                                        <p dir="auto"><span class="" style="font-weight: normal;"><span data-infocase="customer_gender" style="text-transform: capitalize;">Anh</span> <span data-infocase="customer_name">Liêm</span></span>
                                            thân mến!<br>
                                            <br>
                    ...
                    <div class="_panel__form">
                        <div class="_panel__form--column">
                            ...
                            <div class="_panel__form--panel" data-panel_title="Your name">
                                ...
                                <input type="text" name="your-name" value="YOUR NAME" data-infosetting="your-name">
                            </div>
